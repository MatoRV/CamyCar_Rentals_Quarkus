...
public class CrearReservaServiceTest {
    ...
    void crearReservaOk() throws IOException {
        ...
        MaquinaDtoResponse maquinaDtoResponse =
                new MaquinaDtoResponse(1, "F1", "M1", 1500, EstadoEnum.ALQUILADO, tipoMaquinaNombreDtoResponse, 4500, diasReservadosDtoResponse);
        ReservaDtoResponse reservaDtoResponse = new ReservaDtoResponse(1, maquinaDtoResponse, "Cliente 1", "direccion 1");
