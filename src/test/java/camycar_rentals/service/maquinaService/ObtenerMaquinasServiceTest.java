...
public class ObtenerMaquinasServiceTest {
    ...
    void obtenerMaquinasOk() {
        ...
        MaquinaDtoResponse maquinaDtoResponse1 = new MaquinaDtoResponse(1,"F1","M1",1500,tipoMaquinaDtoResponse);
        MaquinaDtoResponse maquinaDtoResponse2 = new MaquinaDtoResponse(2, "F1","M2",2000,tipoMaquinaDtoResponse);
