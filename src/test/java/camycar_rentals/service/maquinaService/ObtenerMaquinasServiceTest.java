...
public class ObtenerMaquinasServiceTest {
    ...
    void obtenerMaquinasOk() {
        ...
        MaquinaDtoResponse maquinaDtoResponse1 =
                new MaquinaDtoResponse(1, "F1", "M1", 1500, EstadoEnum.DISPONIBLE, tipoMaquinaNombreDtoResponse, 4500, diasReservadosDtoResponse);
        MaquinaDtoResponse maquinaDtoResponse2 =
                new MaquinaDtoResponse(2, "F1", "M2", 2000, EstadoEnum.DISPONIBLE, tipoMaquinaNombreDtoResponse, 4500, diasReservadosDtoResponse);
