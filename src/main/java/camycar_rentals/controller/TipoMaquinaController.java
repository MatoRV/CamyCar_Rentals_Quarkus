...
public class TipoMaquinaController extends BaseController {
    ...
    @PUT
    @Path("/{idTipoMaquina}")
    @Operation(summary = "Edita un tipo de maquina por su id")
    @APIResponse(responseCode = "201", description = "CREATED", content = @Content(schema = @Schema(implementation = TipoMaquinaDtoResponse.class)))
    @APIResponse(responseCode = "400", description = "BAD REQUEST")
    @APIResponse(responseCode = "404", description = "NOT FOUND")
    public Response editarTipoMaquinaPorId(@PathParam("idTipoMaquina") Integer idTipoMaquina, TipoMaquinaDtoRequest tipoMaquinaDtoRequest) {
        return Response.status(Response.Status.CREATED).entity(tipoMaquinaService.editarTipoMaquinaPorId(idTipoMaquina, tipoMaquinaDtoRequest)).build();
    }

    @DELETE
    @Path("/{idTipoMaquina}")
    @Operation(summary = "Elimina un tipo de maquina por su id")
    @APIResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = TipoMaquinaDtoResponse.class)))
    @APIResponse(responseCode = "400", description = "BAD REQUEST")
    @APIResponse(responseCode = "404", description = "NOT FOUND")
    public Response eliminarTipoMaquinaPorId(@PathParam("idTipoMaquina") Integer idTipoMaquina) {
        return Response.status(Response.Status.OK).entity(tipoMaquinaService.eliminarTipoMaquinaPorId(idTipoMaquina)).build();
    }
}
